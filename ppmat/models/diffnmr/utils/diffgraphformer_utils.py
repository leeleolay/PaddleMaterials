...
class PlaceHolder:
    ...
    mask(node_mask, collapse: bool = False) -> PlaceHolder
        ...
        - If `collapse == True`:
            ...
            * Any masked node (0) is set to -1 in X; any edge touching a masked node is set to -1 in E.
            * Use -1 as a sentinel/padding id; change if your downstream code requires a different pad id.
    """
