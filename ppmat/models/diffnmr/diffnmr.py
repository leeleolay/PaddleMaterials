...
class _DiffNMRSamplingMixin:
    ...
    def sample(
        ...
        *,
        ...
        """Generate molecular graphs from a standard DiffNMR batch."""
        ...
        if self.visualization_tools is not None:
            ...
            self.visualization_tools.visualizeNmr(
                batch_id, molecule_list, molecule_true, visual_num
            )

        if return_onehot:
            return molecule_list, molecule_true, X_hot, E_hot
        return molecule_list, molecule_true
