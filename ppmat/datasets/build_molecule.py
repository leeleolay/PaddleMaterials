...
class BuildMolecule:
    ...
    def __init__(
        self,
        format: Literal["smiles", "mol_block", "mol_file", "sdf_file", "inchi", "dict", "rdmol"],
        sanitize: bool = True,
        add_hs: bool = False,
    ...
    @staticmethod
    def _post_process(mol: Chem.Mol, sanitize: bool, add_hs: bool, remove_hs: bool, kekulize: bool) -> Chem.Mol:
        if mol is None:
            return None
        if sanitize:
    ...
    def __call__(self, molecules_data: Union[Sequence[Any], Any]) -> Union[List[Chem.Mol], Chem.Mol, None]:
