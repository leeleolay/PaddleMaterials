...
class StructureSampler(BaseSampler):
    """Structure Sampler.
    ...
    def _get_default_sample_params(self):
        return self.sample_config.get("model_sample_params", {}) or {}
    ...
    def sample_by_dataloader(
        ...
        data_loader = build_dataloader(
            dataset_cfg, vocab=build_vocab(self.config.get("Vocabulary"))
        )
